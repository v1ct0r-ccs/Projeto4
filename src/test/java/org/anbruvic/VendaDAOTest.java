...
import org.anbruvic.dao.generic.jdbc.ConnectionFactory;
...
public class VendaDAOTest {
	...
	private Produto cadastrarProduto(String codigo, BigDecimal valor) throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException, DAOException {
		...
		produto.setDescricao("Produto Z");
		produto.setModelo("Modelo4");
		produto.setCor("Parecida com a outra");
		produto.setNome("Produto Z");
		produto.setValor(valor);
		//produto.setQuantidade_estoque(40);
